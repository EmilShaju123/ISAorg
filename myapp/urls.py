...
urlpatterns = [
    ...
    path('truckup/<str:id>/', views.truckup, name="truckup"),
    path('detail', views.detail, name="detail"),
    path('partyup/<str:id>/', views.partyup, name="partyup"),
    path('driverdel/<str:id>/', views.driverdel, name="driverdel"),
    path('tripdel/<str:id>/', views.tripdel, name="tripdel"),
    path('placedel/<str:id>/', views.placedel, name="placedel"),
    path('partydel/<str:id>/', views.partydel, name="partydel"),
    path('recycle', views.recycle, name="recycle"),
    path('partyrestore/<str:id>/', views.partyrestore, name="partyrestore"),
    path('placerestore/<str:id>/', views.placerestore, name="placerestore"),
    path('driverrestore/<str:id>/', views.driverrestore, name="driverrestore"),
    path('shiftrestore/<str:id>/', views.shiftrestore, name="shiftrestore"),
    path('reassign', views.reassign, name="reassign"),
    path('assignup/<str:id>/', views.assignup, name="assignup"),
    path('monthlyprofit', views.monthlyprofit, name="monthlyprofit"),
    path('monthupdate', views.monthupdate, name="monthupdate"),
    path('updatemonth', views.updatemonth, name="updatemonth"),
    path('transdel/<str:id>/', views.transdel, name="transdel"),
    path('transrestore/<str:id>/', views.transrestore, name="transrestore"),
    path('stafftruckview', views.stafftruckview, name="stafftruckview"),
    path('stafftruckup/<str:id>/', views.stafftruckup, name="stafftruckup"),
    path('battareg', views.battareg, name="battareg"),
    path('driverup/<str:id>/', views.driverup, name="driverup"),
    path('battaregup/<str:id>/', views.battaregup, name="battaregup"),
    path('monthprofit', views.monthprofit, name="monthprofit"),
